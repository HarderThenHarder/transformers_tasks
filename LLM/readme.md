...
```python
>>> User: 岳云鹏，本名岳龙刚，1985年4月15日出生于河南省濮阳市南乐县，中国内地相声、影视男演员。2005年，首次登台演出。2012年，主演卢卫国
执导的喜剧电影《就是闹着玩的》。2013年在北京举办相声专场。提取上述句子中“人物”(姓名, 性别, 出生日期, 出生地点, 职业, 获得奖项, 
实体类型)，“书籍”(名称, 作者, 类型, 发行时间, 定价, 实体类型)，“电视剧”(名称, 导演, 演员, 题材, 出品方, 
实体类型)类型的实体，并按照JSON格式输出。
>>> Bot: {"姓名": ["岳云鹏"], "性别": ["男"], "出生日期": ["1985年4月15日"], "出生地点": ["河南省濮阳市南乐县"], "职业": ["相声演员", 
"影视演员"], "获得奖项": [], "实体类型": ["人物"]}
...
```
